# 1 "d:\\.PROJECT\\HangeulClock_DIY_v1\\Programming\\han_clock\\han_clock.ino"
...
*/
# 10 "d:\\.PROJECT\\HangeulClock_DIY_v1\\Programming\\han_clock\\han_clock.ino"
//헤더파일 선언
# 12 "d:\\.PROJECT\\HangeulClock_DIY_v1\\Programming\\han_clock\\han_clock.ino" 2

# 14 "d:\\.PROJECT\\HangeulClock_DIY_v1\\Programming\\han_clock\\han_clock.ino" 2
...
Adafruit_NeoPixel strip(36, 6, ((1<<6) | (1<<4) | (0<<2) | (2)) /*|< Transmit as G,R,B*/ + 0x0000 /*|< 800 KHz data transmission*/);
...
bool ledCheck = false;
bool bu_reading[2] = { 0x1, 0x1 }; //버튼의 실제 상태를 표현하는 변수
bool bu_state[2] = { 0x1, 0x1 }; //체터링을 거른 버튼의 상태를 표현하는 변수
bool last_bu_state[2] = { 0x1, 0x1 }; //마지막 버튼 상태
